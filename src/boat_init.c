...
/*
    ...
    XrmInitialize();
*/
    _glfw.boat.display = boat_server_GetNativeDisplay();
    //EGL_DEFAULT_DISPLAY is zero.
    /*
    if (!_glfw.boat.display)
    {
        ...
        {
            _glfwInputError(GLFW_PLATFORM_ERROR,
                            "Boat: The DISPLAY environment variable is missing");
        }
...
{
    return _GLFW_VERSION_NUMBER " Android EGL OSMesa"
