...
void _glfwPlatformGetMonitorWorkarea(_GLFWmonitor* monitor, int* xpos, int* ypos, int* width, int* height)
{
    ...
    if (ypos)
        *ypos = 0;
    if (width)
        *width = 0;    //boat_patch: unknown
    if (height)
        *height = 0;   //boat_patch: unknown
}
...
/*
    ...
    */
    ...
    mode->width = 0;     //boat_patch: unknown
    mode->height = 0;    //boat_patch: unknown
    mode->refreshRate = 60;
...
/*
    ...
    */
    ...
    _glfwInputError(GLFW_PLATFORM_ERROR,
                    "Boat: Gamma ramp access not supported by server");
    return GLFW_FALSE;
}
